...
@Autonomous(name="EncoderFB", group="Auto")
//@Disabled
public class EncoderFB extends LinearOpMode {
...
encoderDrive(DRIVE_SPEED,  20,  -20, 20, -20, 1.0);  // S1: Forward 24 Inches with 5 Sec timeout
        ...
        encoderDrive(.3,  18,  -18, 18, -18, 1.0); 
        sleep(750);
        leftServo.setPosition(.90);            // S4: Stop and close the claw.
        rightServo.setPosition(-.90);
         sleep(950);
      
     encoderDrive(.6, -45, 45, -45, 45, 5.0);
        //push out
          encoderDrive(.6,  -38, 38, 38, -38, 9.5);
        leftServo.setPosition(-0.90);
    rightServo.setPosition(.90);
     sleep(150);
        encoderDrive(.7,  38, -38, 38, -38, 6.5);
 encoderDrive(.7,  -23, 23, -23, 23, 9.5);
