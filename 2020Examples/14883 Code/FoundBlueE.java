...
@Autonomous(name="FoundBlueE", group="Auto")
//@Disabled
public class FoundBlueE extends LinearOpMode {
...
encoderDrive(DRIVE_SPEED,  20,  -20, 20, -20, 1.0);  // S1: Forward 24 Inches with 5 Sec timeout
        encoderDrive(STRAFE_SPEED,   30, -30, -30, 30, 2.0);// S2: Strafe Left 12 Inches with 4 Sec timeout
...
//drive forward
    ...
    //
     encoderDrive(DRIVE_SPEED,  3, -3, 3, -3, 4.5);
        leftServo.setPosition(-1.3);            // S4: Stop and close the claw.
        rightServo.setPosition(.99);
         sleep(750);
         // pause for servos to move

        encoderDrive(.6, -55, 55, -55, 55, 7.0);
//reverse with found
        leftServo.setPosition(0.5);            // S4: Stop and close the claw.
     ...
     sleep(1150);
       //pick up fond servos
        ...
        linearmotor.setPower(0);
           ...
           encoderDrive(DRIVE_SPEED,  -15, 15, 15, -15, 4.5);
//strafe out
        ...
        linearmotor.setPower(0);
        //push out
        encoderDrive(DRIVE_SPEED,  -35, 35, 35, -35, 9.5);
//strafe to park
