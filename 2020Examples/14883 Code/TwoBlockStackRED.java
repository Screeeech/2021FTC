...
@Autonomous(name="TwoBlockStackRED", group="Auto")
//@Disabled
public class TwoBlockStackRED extends LinearOpMode {
 ...
 encoderDrive(DRIVE_SPEED,  23, -23, 23, -23, 4.5);
//drive to stone
linearServo.setPosition(.1);
sleep(1350);
//pick stone
encoderDrive(DRIVE_SPEED,  -29, 29, -29, 29, 4.5);
//reverse with stone
...
//lift stone
encoderDrive(DRIVE_SPEED,  -33, 33, 33, -33, 9.5);
//strafe to found side
encoderDrive(DRIVE_SPEED,  20,  -20, 20, -20, 1.0);  // S1: Forward 24 Inches with 5 Sec timeout
//forward to found
        encoderDrive(STRAFE_SPEED,   -27, 27, 27, -27, 2.0);// S2: Strafe Left 12 Inches with 4 Sec timeout
        //strafe lower slight more
        linearmotor.setPower(-.4);
        sleep(1050);
        linearmotor.setPower(0);
//pick up linear slide
        encoderDrive(DRIVE_SPEED, 10, -10, 10, -10, 4.0);  // S3: Forward 12 Inches with 4 Sec timeout
//drive forward un poco
    linearServo.setPosition(1);
    sleep(150);
    //drop up block 
    
    //
     encoderDrive(DRIVE_SPEED,  -28, 28, -28, 28, 4.5);
     linearmotor.setPower(.5);
     sleep(450);
     linearmotor.setPower(0);
      
     encoderDrive(STRAFE_SPEED,   57, -57, -57, 57, 4.0);


 encoderDrive(DRIVE_SPEED,  13, -13, 13, -13, 4.5);
 encoderDrive(STRAFE_SPEED,   7, -7, -7, 7, 4.0);
//drive to stone
linearServo.setPosition(.1);
sleep(1350);
//pick stone
...
linearmotor.setPower(0);
//bridge lower
encoderDrive(DRIVE_SPEED,  -53, 53, 53, -53, 9.5);
//strafe to found side
encoderDrive(DRIVE_SPEED,  20,  -20, 20, -20, 1.0);  // S1: Forward 24 Inches with 5 Sec timeout
        encoderDrive(STRAFE_SPEED,   -27, 27, 27, -27, 2.0);// S2: Strafe Left 12 Inches with 4 Sec timeout
        //drive forward slight
        linearmotor.setPower(-.4);
        sleep(1050);
        linearmotor.setPower(0);
//pick up linear slide
        encoderDrive(DRIVE_SPEED, 14, -14, 14, -14, 4.0);  // S3: Forward 12 Inches with 4 Sec timeout
//drive forward
