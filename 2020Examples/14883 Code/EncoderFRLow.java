...
@Autonomous(name="EncoderFRLow", group="Auto")
//@Disabled
public class EncoderFRLow extends LinearOpMode {
...
encoderDrive(DRIVE_SPEED,  20,  -20, 20, -20, 1.0);  // S1: Forward 24 Inches with 5 Sec timeout
        encoderDrive(STRAFE_SPEED,   -12, 12, 12, -12, 2.0);// S2: Strafe Left 12 Inches with 4 Sec timeout
        linearmotor.setPower(-.4);
        sleep(1050);
        linearmotor.setPower(0);
        encoderDrive(.3,  20,  -20, 20, -20, 1.0); 
        sleep(750);
        leftServo.setPosition(.95);            // S4: Stop and close the claw.
        rightServo.setPosition(-.95);
         sleep(950);
      
     encoderDrive(.6, -45, 45, -45, 45, 5.0);
        //push out
          encoderDrive(.6,  45, -45, -45, 45, 9.5);
        leftServo.setPosition(-0.90);
    rightServo.setPosition(.90);
     sleep(150);
        encoderDrive(.7,  38, -38, 38, -38, 6.5);
 encoderDrive(.7,  -10, 10, -10, 10, 9.5);
  encoderDrive(.7,  -7, 7, 7, -7, 9.5);
  encoderDrive(.7,  -10, 10, 10, -10, 9.5);
  encoderDrive(.7,  -14, 14, -14, 14, 9.5);
